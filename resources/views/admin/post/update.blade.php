...
@endif
        ...
        <div class="col-7">
          ...
          <div class="col-5">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title font-weight-bold pt-2">Post Update</h3>
                    <span class="" style="margin-left: 13rem"><a href="{{ route('admin#post') }}"><button class="btn text-white" style="background: rgb(128, 93, 66)">Add Post + </button></a></span>
          </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive p-2 px-3">
                <form action="{{ route('admin#postUpdate') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="postId" value="{{ $edit->post_id }}" hidden>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Title</label>
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror " id="exampleFormControlInput1" value="{{ $edit->title }}">
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category" id="" class="form-control">
                            ...
                            <option value="{{ $c->category_id }}" @if ($c->category_id == $edit->category_id)
                                selected
                    ...
                    <div class="mb-3">
                        ...
                        @if ($edit->image == null)
                        <img src="{{asset('storage/default.png')}}" class="mx-3 my-3 shadow-sm" alt="" style="width: 250px; height: 250px">
                        @else
                        <img src="{{asset('storage/'.$edit->image )}}" class="mx-3 my-3 shadow-sm" alt="" style="width: 250px; height: 250px">
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="" class="form-control  @error('description') is-invalid @enderror ">{{ $edit->description }}</textarea>
                        @error('description')
                        <div class="is-invalid">
                            <span class="text-danger">{{ $message }}</span>
                        </div>
